...
CardCatalog-Карточка товара на главной странице (в каталоге)
CardPreview-Карточка товара в модальном окне (для просмотра)
CardBasket-Карточка товара в корзине
BaseCard-(абстрактный) Общий родитель для всех карточек
Modal-Модальное окно — универсальный контейнер
Basket-Компонент корзины: список товаров, итоговая цена, кнопка оформления
OrderFormFirstStep-Форма оформления заказа: выбор оплаты, адрес
OrderFormSecondStep-Форма: email и телефон
OrderFormSuccess-Уведомление об успешной оплате
BaseForm-(абстрактный) Общий родитель для всех форм
Page-Главная страница: каталог + иконка корзины